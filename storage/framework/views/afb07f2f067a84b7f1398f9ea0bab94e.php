                        ...
                        <form method="POST" action="<?php echo e(route('login.post')); ?>" id="loginForm">
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none fw-bold">Lupa password?</a>
                                </div>
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="remember" value="1" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\auth\login.blade.php ENDPATH**/ ?>