                ...
                <table id="adminKatalogTable" class="table table-hover align-middle orders-table">
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <form action="<?php echo e(route('admin.katalog.toggle', $item->id)); ?>" method="POST" class="catalog-status-form" title="<?php echo e($item->is_active ? 'Katalog tampil di halaman publik' : 'Katalog disembunyikan dari halaman publik'); ?>">
                                            <?php echo csrf_field(); ?>
                                            <span class="catalog-status-caption">Tampilkan katalog</span>
                                            <label class="catalog-status-switch" aria-label="<?php echo e($item->is_active ? 'Matikan tampilan katalog' : 'Tampilkan katalog'); ?>">
                                                <input type="checkbox" <?php echo e($item->is_active ? 'checked' : ''); ?> onchange="this.form.submit()">
                                                <span class="catalog-status-slider"></span>
                                            </label>
                                            <span class="catalog-status-label"><?php echo e($item->is_active ? 'On' : 'Off'); ?></span>
                                        </form>
                                        <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailKatalogModal<?php echo e($item->id); ?>">
                            ...
                            <div class="modal fade" id="detailKatalogModal<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                <div class="col-md-5 text-center">
                                                    <?php if(!empty($item->image)): ?>
                                                        <img src="<?php echo e($katalogImageSrc); ?>" alt="<?php echo e($item->name); ?>" class="img-fluid rounded" style="max-height:260px; object-fit:contain;">
                                                    <?php else: ?>
                                                        <span class="text-muted">Tidak ada gambar</span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="mb-3"><strong>Nama Katalog:</strong><br><?php echo e($item->name); ?></div>
                                                    <div class="mb-3"><strong>Kategori:</strong><br><?php echo e($item->kategori); ?></div>
                                                    <div><strong>Deskripsi:</strong><br><?php echo nl2br(e($item->description)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="kostum-upload-grid">
                                                        <div class="kostum-upload-card">
                                                            <div class="kostum-upload-preview-wrap" id="editKatalogPreviewWrap<?php echo e($item->id); ?>">
                                                                <?php if($catalogImageSrc): ?>
                                                                    <img src="<?php echo e($catalogImageSrc); ?>" alt="Gambar katalog <?php echo e($item->name); ?>" class="kostum-upload-preview" id="editKatalogPreview<?php echo e($item->id); ?>">
                                                                <?php else: ?>
                                                                    <div class="kostum-upload-empty" id="editKatalogEmpty<?php echo e($item->id); ?>">Gambar Katalog</div>
                                                                    <img src="" alt="Preview gambar katalog" class="kostum-upload-preview d-none" id="editKatalogPreview<?php echo e($item->id); ?>">
                                                                <?php endif; ?>
                                                            </div>
                                                            <label for="editKatalogImage<?php echo e($item->id); ?>" class="btn btn-outline-secondary w-100 mb-0">
                                                                <i class="bi bi-image"></i> Pilih Gambar
                                                            </label>
                                                            <input type="file" class="d-none js-katalog-upload-input" id="editKatalogImage<?php echo e($item->id); ?>" name="image" accept="image/*,.jpg,.jpeg,.png,.gif,.webp,.svg,.bmp,.tiff,.ico" data-preview-id="editKatalogPreview<?php echo e($item->id); ?>" data-empty-id="editKatalogEmpty<?php echo e($item->id); ?>" data-remove-id="remove_image_<?php echo e($item->id); ?>">
                                                            <button type="button" class="btn btn-outline-danger btn-sm js-remove-katalog-image <?php echo e($catalogImageSrc ? '' : 'd-none'); ?>" data-preview-id="editKatalogPreview<?php echo e($item->id); ?>" data-empty-id="editKatalogEmpty<?php echo e($item->id); ?>" data-file-input-id="editKatalogImage<?php echo e($item->id); ?>" data-remove-input-id="remove_image_<?php echo e($item->id); ?>">
                                                                <i class="bi bi-trash"></i> Hapus Gambar
                                                            </button>
                                                            <input type="hidden" name="remove_image" id="remove_image_<?php echo e($item->id); ?>" value="0">
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\admin\data-katalog.blade.php ENDPATH**/ ?>