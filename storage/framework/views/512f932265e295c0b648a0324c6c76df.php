                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-2"><strong>Metode Pembayaran:</strong><br><?php echo e(strtoupper((string) $item->metode_pembayaran) === 'COD' ? 'Tunai (COD)' : ($item->metode_pembayaran ?? '-')); ?></div>
                                                    <?php if(strtoupper((string) $item->metode_pembayaran) !== 'COD'): ?>
                                                        <?php
                                                        ...
                                                        <div class="mb-2"><strong>Bukti Pembayaran:</strong><br>
                                                            <?php if($detailBuktiPath && $detailBuktiExt === 'pdf'): ?>
                                                                <a href="<?php echo e($detailBuktiPath); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-outline-primary mt-1"><i class="bi bi-file-earmark-pdf"></i> Lihat PDF</a>
                                                            <?php elseif($detailBuktiPath): ?>
                                                                <img src="<?php echo e($detailBuktiPath); ?>" alt="Bukti Pembayaran" class="img-fluid rounded mt-1" style="max-height:220px; object-fit:contain;">
                                                            <?php else: ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\admin\data-pesanan.blade.php ENDPATH**/ ?>