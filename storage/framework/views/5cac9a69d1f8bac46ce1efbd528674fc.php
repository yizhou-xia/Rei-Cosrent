    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-4">
                <?php if($qrisSrc): ?>
                    <img src="<?php echo e($qrisSrc); ?>" alt="QRIS Pembayaran Denda Ukuran Besar" class="qris-preview-image rounded border">
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\user\bayar-denda.blade.php ENDPATH**/ ?>