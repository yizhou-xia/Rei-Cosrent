...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Rei Cosrent'); ?></title>
...
<body data-bs-theme="light" class="<?php echo e(request()->routeIs('home') ? 'homepage' : ''); ?> <?php echo e(request()->routeIs('admin.*') ? 'admin-page' : ''); ?>">
    ...
    <nav class="navbar navbar-expand-lg fixed-top shadow-sm ak-navbar" style="background-color: var(--bs-body-bg); width: calc(100% - 17px); right: 0;">
        <div class="container-fluid container">
            ...
            <a class="navbar-brand fw-bold text-primary" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('assets/img/Water Mark.png')); ?>" alt="Logo Rei Cosrent" width="48" height="48" class="me-2">
            ...
            <ul class="navbar-nav nav-center d-none d-lg-flex align-items-center">
                <li class="nav-item"><a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(request()->routeIs('home') ? '#kategori' : route('home') . '#kategori'); ?>">Katalog</a></li>
                <li class="nav-item"><a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(request()->routeIs('home') ? '#profil' : route('home') . '#profil'); ?>">Profil</a></li>
                <li class="nav-item"><a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(request()->routeIs('home') ? '#kontak' : route('home') . '#kontak'); ?>">Informasi</a></li>
                <li class="nav-item"><a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(route('peraturan')); ?>">Aturan</a></li>
                <li class="nav-item ms-lg-2">
                    <a class="nav-link fw-semibold d-flex align-items-center gap-2 ak-nav-btn" href="<?php echo e(route('tanggal.pemesanan')); ?>">
                        Lihat Tanggal
                    </a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav mb-0 align-items-center navbar-account-controls">
                ...
                <?php if(session('admin_logged_in')): ?>
                    <li class="nav-item account-profile-item">
                        <a class="nav-link fw-semibold d-flex align-items-center gap-2 ak-nav-btn account-profile-link" href="<?php echo e(route('admin.profile')); ?>" aria-label="Profil admin">
                            <?php if($adminProfilePhotoSrc): ?>
                                <div style="width: 32px; height: 32px; border-radius: 50%; background-size: cover; background-position: center; background-image: url('<?php echo e($adminProfilePhotoSrc); ?>'); border: 1px solid var(--bs-border-color);"></div>
                            <?php else: ?>
                                <i class="bi bi-person-badge"></i>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php elseif(session('user_logged_in')): ?>
                    <li class="nav-item account-profile-item">
                        <a class="nav-link fw-semibold d-flex align-items-center gap-2 ak-nav-btn account-profile-link" href="<?php echo e(route('user.profile')); ?>" aria-label="Profil pengguna">
                ...
                <?php elseif(!session('admin_logged_in') && !session('user_logged_in')): ?>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(route('login')); ?>">Login</a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <div class="row gy-4">
                <div class="col-md-8 footer-col">
                    <div class="footer-logo mb-2">
                        <img src="<?php echo e(asset('assets/img/Water Mark.png')); ?>" alt="Logo" width="48" height="48">
                        <div>
                ...
                <div class="col-md-4 footer-col text-md-end">
                    ...
                    <?php if(session('admin_logged_in') || session('user_logged_in')): ?>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-sm rounded-pill">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                text: <?php echo json_encode($logoutMessage, 15, 512) ?>,
    ...
    <?php if((session('admin_logged_in') || session('user_logged_in')) && !session('auth_remember')): ?>
    <script>
        (function () {
            ...
            fetch(<?php echo json_encode(route('logout'), 15, 512) ?>, {
                method: 'GET',
                credentials: 'same-origin',
                keepalive: true,
            }).finally(function () {
                window.location.replace(<?php echo json_encode(route('login'), 15, 512) ?>);
            });
        }());
    </script>
    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\rc3\resources\views\layouts\main.blade.php ENDPATH**/ ?>