                ...
                <table class="table table-hover align-middle orders-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell text-center"><?php echo e($d->created_at ? $d->created_at->format('d M Y') : '-'); ?></td>
                            <td class="text-end">
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-info w-100" data-bs-toggle="modal" data-bs-target="#dendaDetailModal-<?php echo e($d->id); ?>">
                                    ...
                                    <?php if($hasBukti): ?>
                                        <button type="button" class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#buktiModal-<?php echo e($d->id); ?>">
                                            <i class="bi bi-eye"></i> Lihat Bukti
                                        </button>
                                    <?php else: ?>
                                        <?php if(strtolower($d->status) === strtolower('Belum Lunas')): ?>
                                            <a href="<?php echo e(route('denda.bayar', $d->id)); ?>" class="btn btn-success btn-sm w-100">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary text-white">
                                        <h5 class="modal-title" id="dendaDetailLabel-<?php echo e($d->id); ?>">Detail Denda</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <?php if($detailBuktiPembayaranPath): ?>
                                                <div class="mt-2">
                                                    <?php if($detailBuktiPembayaranExt === 'pdf'): ?>
                                                        <embed src="<?php echo e($detailBuktiPembayaranPath); ?>" type="application/pdf" width="100%" height="420px" />
                                                    <?php else: ?>
                                                        <img src="<?php echo e($detailBuktiPembayaranPath); ?>" alt="Bukti Pembayaran Denda" class="img-fluid rounded" style="max-height:420px; object-fit:contain; width:100%;" onerror="this.outerHTML = '<a href=\'<?php echo e($detailBuktiPembayaranPath); ?>\' target=\'_blank\' class=\'btn btn-outline-secondary\'>Download / Lihat File</a>'">
                                                    <?php endif; ?>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if($detailBuktiCount > 0): ?>
                                                <div class="row g-2 mt-1">
                                                    <?php $__currentLoopData = $detailBuktiFotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\user\denda-saya.blade.php ENDPATH**/ ?>