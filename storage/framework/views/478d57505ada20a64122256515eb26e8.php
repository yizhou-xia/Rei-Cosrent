                    ...
                    <tbody>
                        <?php $__currentLoopData = $activeOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm <?php echo e($isReapplyOrder ? 'btn-outline-warning' : 'btn-outline-primary'); ?> w-100" data-bs-toggle="modal" data-bs-target="#returnModal-<?php echo e($order->id); ?>" <?php echo e($canSubmitReturn ? '' : 'disabled'); ?>>
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <?php if(($request->status ?? '') === 'ditolak' && data_get($request, 'formulir.id')): ?>
                                            ...
                                            <button type="button"
                                                ...
                                                data-tanggal-pemesanan="<?php echo e(data_get($formulir, 'created_at')); ?>"
            ...
            <form method="POST" action="<?php echo e(route('user.pengembalian.submit', $order->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                            ...
                            <div class="row g-2">
                                <?php $__currentLoopData = ['gambar1', 'gambar2', 'gambar3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php if($imagePath): ?>
                                            <button type="button" class="btn p-0 border-0 bg-transparent return-photo-detail-trigger" data-photo-src="<?php echo e(asset('storage/' . $imagePath)); ?>" data-photo-title="<?php echo e($imageLabel); ?> sebelumnya" aria-label="Lihat detail <?php echo e($imageLabel); ?> sebelumnya">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="return-upload-preview" data-preview-for="gambar1_<?php echo e($order->id); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="return-upload-preview" data-preview-for="gambar2_<?php echo e($order->id); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="return-upload-preview" data-preview-for="gambar3_<?php echo e($order->id); ?>">
...
<div class="modal fade" id="historyModal-<?php echo e($request->id); ?>" tabindex="-1" aria-labelledby="historyModalLabel-<?php echo e($request->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #0d6efd !important; color: #ffffff !important; border-color: #0d6efd !important;">
                <h5 class="modal-title" id="historyModalLabel-<?php echo e($request->id); ?>">Detail Pengembalian</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <?php if($request): ?>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="small text-muted mb-1">Tanggal Pemesanan</div>
                            <div class="fw-semibold">
                                <?php if($tanggalPemesanan): ?>
                                    <?php echo e(\Carbon\Carbon::parse($tanggalPemesanan)->format('d M Y')); ?><br>
                                    <?php echo e(\Carbon\Carbon::parse($tanggalPemesanan)->format('H:i:s')); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <div><span class="badge status-badge <?php echo e($statusData[1]); ?>"><?php echo e($statusData[0]); ?></span></div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <?php if($request->gambar1): ?>
                                <button type="button" class="btn p-0 border-0 bg-transparent return-photo-detail-trigger" data-photo-src="<?php echo e(asset('storage/' . $request->gambar1)); ?>" data-photo-title="Gambar 1" aria-label="Lihat detail gambar 1">
                        ...
                        <div class="col-md-4">
                            <?php if($request->gambar2): ?>
                                <button type="button" class="btn p-0 border-0 bg-transparent return-photo-detail-trigger" data-photo-src="<?php echo e(asset('storage/' . $request->gambar2)); ?>" data-photo-title="Gambar 2" aria-label="Lihat detail gambar 2">
                        ...
                        <div class="col-md-4">
                            <?php if($request->gambar3): ?>
                                <button type="button" class="btn p-0 border-0 bg-transparent return-photo-detail-trigger" data-photo-src="<?php echo e(asset('storage/' . $request->gambar3)); ?>" data-photo-title="Gambar 3" aria-label="Lihat detail gambar 3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\user\pengembalian-saya.blade.php ENDPATH**/ ?>