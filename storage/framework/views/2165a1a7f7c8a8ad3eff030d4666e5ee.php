                    ...
                    <table id="adminKostumTable" class="table table-hover align-middle orders-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->katalog ?: '-'); ?></td>
                                <td><?php echo e($item->kategori ?: '-'); ?></td>
                                <td><?php echo e($item->judul ?: '-'); ?></td>
                                <td>
                                    <?php if(!empty($item->gambar1)): ?>
                                            <?php
                                                $imgRaw = $item->gambar1 ?? '';
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <form action="<?php echo e(route('admin.kostum.toggle', $item->id_kostum)); ?>" method="POST" class="kostum-status-form" title="<?php echo e($item->is_active ? 'Kostum tampil di katalog publik' : 'Kostum disembunyikan dari katalog publik'); ?>">
                                            <?php echo csrf_field(); ?>
                                            <span class="kostum-status-caption">Tampilkan kostum</span>
                                            <label class="kostum-status-switch" aria-label="<?php echo e($item->is_active ? 'Sembunyikan kostum' : 'Tampilkan kostum'); ?>">
                                                <input type="hidden" name="status" value="active">
                                                <input type="checkbox" <?php echo e($item->is_active ? 'checked' : ''); ?> onchange="this.form.submit()">
                                                <span class="kostum-status-slider"></span>
                                            </label>
                                            <span class="kostum-status-label"><?php echo e($item->is_active ? 'On' : 'Off'); ?></span>
                                        </form>
                                        <form action="<?php echo e(route('admin.kostum.toggle', $item->id_kostum)); ?>" method="POST" class="kostum-status-form" title="<?php echo e($item->is_maintenance ? 'Kostum sedang maintenance' : 'Kostum tersedia untuk disewa'); ?>">
                                            <?php echo csrf_field(); ?>
                                            <span class="kostum-status-caption">Maintenance</span>
                                            <label class="kostum-status-switch" aria-label="<?php echo e($item->is_maintenance ? 'Matikan maintenance' : 'Aktifkan maintenance'); ?>">
                                                <input type="hidden" name="status" value="maintenance">
                                                <input type="checkbox" <?php echo e($item->is_maintenance ? 'checked' : ''); ?> onchange="this.form.submit()">
                                                <span class="kostum-status-slider"></span>
                                            </label>
                                            <span class="kostum-status-label"><?php echo e($item->is_maintenance ? 'On' : 'Off'); ?></span>
                                        </form>
                                        <?php if(filled($item->exclude) && !is_null($item->harga_exclude)): ?>
                                            <form action="<?php echo e(route('admin.kostum.toggle', $item->id_kostum)); ?>" method="POST" class="kostum-status-form" title="<?php echo e($item->is_exclude_active ? 'Sewa dengan exclude aktif' : 'Sewa dengan exclude nonaktif'); ?>">
                                                <?php echo csrf_field(); ?>
                                                <span class="kostum-status-caption">Sewa Exclude</span>
                                                <label class="kostum-status-switch" aria-label="<?php echo e($item->is_exclude_active ? 'Nonaktifkan sewa exclude' : 'Aktifkan sewa exclude'); ?>">
                                                    <input type="hidden" name="status" value="exclude">
                                                    <input type="checkbox" <?php echo e($item->is_exclude_active ? 'checked' : ''); ?> onchange="this.form.submit()">
                                                    <span class="kostum-status-slider"></span>
                                                </label>
                                                <span class="kostum-status-label"><?php echo e($item->is_exclude_active ? 'On' : 'Off'); ?></span>
                                            </form>
                                        <?php endif; ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                    ...
                                                    <?php if($detailGalleryImages): ?>
                                                        <div class="admin-costume-gallery" data-admin-costume-gallery>
                                                            <div class="admin-costume-gallery-stage">
                                                                ...
                                                                <img src="<?php echo e($detailGalleryImages[0]['src']); ?>" alt="<?php echo e($detailGalleryImages[0]['alt']); ?>" class="admin-costume-gallery-main" data-admin-gallery-main>
                                                            ...
                                                            <div class="admin-costume-gallery-thumbs" role="tablist" aria-label="Pilihan gambar kostum">
                                                                <?php $__currentLoopData = $detailGalleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageIndex => $detailGalleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <button type="button" class="admin-costume-gallery-thumb <?php echo e($imageIndex === 0 ? 'is-active' : ''); ?>" data-admin-gallery-thumb aria-label="Tampilkan gambar <?php echo e($imageIndex + 1); ?>">
                                                                        <img src="<?php echo e($detailGalleryImage['src']); ?>" alt="<?php echo e($detailGalleryImage['alt']); ?>">
                                                                    </button>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="row mb-2"><div class="col-5 text-muted">Katalog</div><div class="col-7">: <?php echo e($item->katalog ?: '-'); ?></div></div>
                                                    <div class="row mb-2"><div class="col-5 text-muted">Kategori</div><div class="col-7">: <?php echo e($item->kategori ?: '-'); ?></div></div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="katalog" class="form-select js-costume-catalog" required>
                                                        ...
                                                        <?php $__currentLoopData = $katalogOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($catalogOption->name); ?>" data-category="<?php echo e($catalogOption->kategori); ?>" <?php echo e(strtolower($catalogOption->name) === strtolower($item->katalog ?? '') ? 'selected' : ''); ?>><?php echo e($catalogOption->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="judul" class="form-control" value="<?php echo e($item->judul ?? ''); ?>" placeholder="Judul karakter" required>
                                                </div>
                                                    ...
                                                    <div class="kostum-upload-grid">
                                                        <?php $__currentLoopData = range(1, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="kostum-upload-card">
                                                                <div class="kostum-upload-preview-wrap" id="editKostumPreviewWrap<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>">
                                                                    <?php if($imageSrc): ?>
                                                                        <img src="<?php echo e($imageSrc); ?>" alt="Gambar <?php echo e($slot); ?> kostum" class="kostum-upload-preview" id="editKostumPreview<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>">
                                                                        <div class="kostum-upload-empty d-none" id="editKostumEmpty<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>">Gambar <?php echo e($slot); ?></div>
                                                                    <?php else: ?>
                                                                        <div class="kostum-upload-empty" id="editKostumEmpty<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>">Gambar <?php echo e($slot); ?></div>
                                                                        <img src="" alt="Preview gambar <?php echo e($slot); ?>" class="kostum-upload-preview d-none" id="editKostumPreview<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>">
                                                                    <?php endif; ?>
                                                                </div>
                                                                <label for="editGambar<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" class="btn btn-outline-secondary w-100 mb-0">
                                                                    <i class="bi bi-image"></i> Gambar <?php echo e($slot); ?>

                                                                </label>
                                                                <input type="file" class="d-none js-kostum-upload-input" id="editGambar<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" name="<?php echo e($fieldName); ?>" accept="image/*,.jpg,.jpeg,.png,.gif,.webp,.svg,.bmp,.tiff,.ico" data-preview-id="editKostumPreview<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" data-empty-id="editKostumEmpty<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" data-remove-id="remove_<?php echo e($fieldName); ?>_<?php echo e($item->id_kostum); ?>">
                                                                <button type="button" class="btn btn-outline-danger btn-sm js-remove-kostum-image <?php echo e($imageSrc ? '' : 'd-none'); ?>" data-preview-id="editKostumPreview<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" data-empty-id="editKostumEmpty<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" data-file-input-id="editGambar<?php echo e($item->id_kostum); ?>_<?php echo e($slot); ?>" data-remove-input-id="remove_<?php echo e($fieldName); ?>_<?php echo e($item->id_kostum); ?>">
                                                                    <i class="bi bi-trash"></i> Hapus Gambar
                                                                </button>
                                                                <input type="hidden" name="remove_<?php echo e($fieldName); ?>" id="remove_<?php echo e($fieldName); ?>_<?php echo e($item->id_kostum); ?>" value="0">
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="harga_exclude" class="form-control" value="<?php echo e($item->harga_exclude); ?>" min="0" step="0.01" placeholder="Contoh: 50000.00">
                                                </div>
                                            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.kostum.store')); ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Katalog</label>
                        <select name="katalog" class="form-select js-costume-catalog" required>
                            <?php if($katalogOptions && count($katalogOptions) > 0): ?>
                                <option value="" selected disabled>Pilih katalog</option>
                                <?php $__currentLoopData = $katalogOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($catalogOption->name); ?>" data-category="<?php echo e($catalogOption->kategori); ?>"><?php echo e($catalogOption->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="kostum-upload-grid">
                            <?php $__currentLoopData = range(1, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="kostum-upload-card">
                                    <div class="kostum-upload-preview-wrap" id="addKostumPreviewWrap<?php echo e($slot); ?>">
                                        <div class="kostum-upload-empty" id="addKostumEmpty<?php echo e($slot); ?>">Gambar <?php echo e($slot); ?></div>
                                        <img src="" alt="Preview gambar <?php echo e($slot); ?>" class="kostum-upload-preview d-none" id="addKostumPreview<?php echo e($slot); ?>">
                                    </div>
                                    <label for="addKostumImage<?php echo e($slot); ?>" class="btn btn-outline-secondary w-100 mb-0">
                                        <i class="bi bi-image"></i> <?php echo e($slot == 1 ? 'Gambar 1 (Wajib)' : 'Gambar ' . $slot); ?>

                                    </label>
                                    <input type="file" class="d-none js-kostum-upload-input" id="addKostumImage<?php echo e($slot); ?>" name="gambar<?php echo e($slot); ?>" accept="image/*,.jpg,.jpeg,.png,.gif,.webp,.svg,.bmp,.tiff,.ico" <?php echo e($slot == 1 ? 'required' : ''); ?> data-preview-id="addKostumPreview<?php echo e($slot); ?>" data-empty-id="addKostumEmpty<?php echo e($slot); ?>">
                                    <button type="button" class="btn btn-outline-danger btn-sm js-remove-kostum-image d-none" data-preview-id="addKostumPreview<?php echo e($slot); ?>" data-empty-id="addKostumEmpty<?php echo e($slot); ?>" data-file-input-id="addKostumImage<?php echo e($slot); ?>">
                                        <i class="bi bi-trash"></i> Hapus Gambar
                                    </button>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\admin\data-kostum.blade.php ENDPATH**/ ?>