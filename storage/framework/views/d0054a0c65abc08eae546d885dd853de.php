                    ...
                    <div class="card-body text-center py-4 d-flex flex-column align-items-center">
                            ...
                            <table class="table table-sm preview-info-table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="colon-col">:</td>
                                        <td class="value-col vision-text"><?php echo e($user->alamat ?: '-'); ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="mt-4 w-100">
                            <div class="d-grid gap-2">
                                ...
                                <a href="<?php echo e(route('user.pengembalian')); ?>" class="btn btn-outline-success d-flex align-items-center justify-content-center gap-2">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\user\profil.blade.php ENDPATH**/ ?>