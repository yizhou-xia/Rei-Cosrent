            ...
            <div class="row dashboard-metric-row g-2 g-md-3">
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value"><?php echo e($pesanan_verifikasi_count ?? 0); ?></div>
                ...
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value"><?php echo e($pengembalian_verifikasi_count ?? 0); ?></div>
                ...
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value"><?php echo e($pesanan_count ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value"><?php echo e($pengembalian_count ?? 0); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row dashboard-metric-row g-2 g-md-3">
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value">Rp <?php echo e(number_format($total_revenue ?? 0, 0, ',', '.')); ?></div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value">Rp <?php echo e(number_format($total_denda ?? 0, 0, ',', '.')); ?></div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl">
                    <div class="data-card admin-surface-card h-100 p-3 text-start">
                        ...
                        <div class="data-card-value">Rp <?php echo e(number_format(($total_revenue ?? 0) + ($total_denda ?? 0), 0, ',', '.')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<aside id="appSidebar" class="app-sidebar">
    ...
    <div class="p-3">
        <div class="d-grid gap-3">
            ...
            <a href="<?php echo e(route('admin.data-tanggal')); ?>" aria-label="Data Tanggal" class="card menu-card shadow-sm border-0 rounded-xl text-decoration-none">
                <div class="card-body p-3 d-flex align-items-center">
            ...
            <a href="<?php echo e(route('admin.data-pengembalian')); ?>" aria-label="Data Pengembalian" class="card menu-card shadow-sm border-0 rounded-xl text-decoration-none">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <small class="text-muted">Total: <?php echo e($pengembalian_count); ?></small>
                    </div>
                </div>
            </a>
    ...
    <div class="app-sidebar-footer">
            <a href="<?php echo e(route('admin.profile.settings')); ?>" aria-label="Profil Admin" class="card menu-card shadow-sm border-0 rounded-xl text-decoration-none mb-2">
            <div class="card-body p-3 d-flex align-items-center">
        ...
        <a href="<?php echo e(route('admin.logout')); ?>" class="sidebar-logout text-decoration-none" aria-label="Logout">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc3\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>