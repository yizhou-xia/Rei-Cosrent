                        ...
                        <div class="col">
                            <a href="#" class="card costume-card rounded-xl h-100 border-0 shadow-sm d-block text-decoration-none text-reset" data-bs-toggle="modal" data-bs-target="#detailModal{{ $k->id_kostum }}">
                                ...
                                <div class="card-body py-2 px-3 costume-card-body">
                                    ...
                                    @endphp
                                    <div class="kostum-rating d-flex align-items-center mb-1" aria-label="Rating {{ number_format($averageRating, 1) }} dari 5 dari {{ $ratingCount }} ulasan">
                                        ...
                                        <span class="kostum-rating-count">{{ $ratingCount ? number_format($averageRating, 1) . ' (' . $ratingCount . ')' : 'Belum ada rating' }}</span>
                                    </div>
                                    ...
                                    @elseif($k->is_currently_rented ?? false)
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                                ...
                                                @if($galleryImages)
                                                    <div class="costume-gallery" data-gallery>
                                                        <div class="costume-gallery-stage">
                                                            ...
                                                            <img src="{{ $galleryImages[0]['src'] }}" alt="{{ $galleryImages[0]['alt'] }}" class="costume-gallery-main" data-gallery-main>
                                                        ...
                                                        <div class="costume-gallery-thumbs" role="tablist" aria-label="Pilihan gambar kostum">
                                                            @foreach($galleryImages as $imageIndex => $galleryImage)
                                                                <button type="button" class="costume-gallery-thumb {{ $imageIndex === 0 ? 'is-active' : '' }}" data-gallery-thumb data-gallery-index="{{ $imageIndex }}" aria-label="Tampilkan gambar {{ $imageIndex + 1 }}">
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{ route('tanggal.pemesanan') }}" class="btn btn-outline-primary">
                                        ...
                                        @elseif(session('user_logged_in') || auth()->check())
                                            @if($isAdmin)
