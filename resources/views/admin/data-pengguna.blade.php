...
@section('title', 'Data Pengguna - Rei Cosrent')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <button class="btn btn-info btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#detailUserModal{{ $user->id }}">
                                                    <i class="bi bi-eye"></i> Detail
                                                </button>
                                                @if($user->password_reset_pending_hash)
                                                    <button class="btn btn-success btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $user->id }}" title="Verifikasi penggantian password">
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-warning text-white">
                                                            <h5 class="modal-title" id="editUserLabel{{ $user->id }}">Verifikasi Penggantian Password Pengguna</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                @if($user->password_reset_pending_hash)
                                                                    <div class="alert alert-warning">
                                                                        ...
                                                                        Pengguna mengajukan penggantian password pada {{ optional($user->password_reset_requested_at)->format('d M Y H:i') }}.
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title" id="detailUserLabel{{ $user->id }}">Detail Pengguna</h5>
                                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row g-4">
                                                                <div class="col-md-4 text-center">
                                                                    @if($avatarPath)
                                                                        <img src="{{ $avatarPath }}" alt="Avatar {{ $user->username }}" class="img-fluid rounded mb-3" style="max-height: 220px; object-fit: cover; border: 1px solid var(--bs-border-color);">
                                                                    @else
