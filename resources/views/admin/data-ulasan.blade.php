                    ...
                    <tbody>
                        @foreach($ulasanList as $index => $u)
                                ...
                                <tr data-date="{{ $u->created_at ? $u->created_at->toDateString() : '' }}">
                                    ...
                                    <td class="text-start">{{ $u->nama_user ?? 'User' }}</td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-start">
                                                            <div class="row g-3 mb-4">
                                                                <div class="col-md-6"><strong>Username:</strong><br>{{ $u->nama_user ?? 'User' }}</div>
                                                                <div class="col-md-6"><strong>Nama Kostum:</strong><br>{{ $u->nama_kostum ?? '-' }}</div>
                                                                <div class="col-md-6"><strong>Email:</strong><br>{{ $u->email_user ?? '-' }}</div>
                                                                <div class="col-md-6"><strong>Tanggal:</strong><br>{{ $u->created_at ? $u->created_at->format('d M Y H:i') : '-' }}</div>
                                                                <div class="col-md-6"><strong>Rating:</strong><br>{{ $u->rating ?? '-' }} / 5</div>
                                                                <div class="col-md-6"><strong>Status Pesanan:</strong><br>{{ $u->status_pesanan ?? '-' }}</div>
                                                                <div class="col-12"><strong>Ulasan:</strong><br>{{ $u->review ?: '(Tidak ada teks ulasan)' }}</div>
                                                                <div class="col-12"><strong>Balasan Admin:</strong><br>{{ $u->balasan ?: '(Belum ada balasan)' }}</div>
                                                            </div>
                                                                ...
                                                                <div class="row g-3 mt-1">
                                                                    @foreach($images as $num => $img)
                                                                        <div class="col-6 col-md-4">
                                                                            <button type="button" class="btn ulasan-image-preview-trigger" data-preview-src="{{ asset('storage/' . $img) }}" data-preview-title="Gambar {{ $num }}" onclick="return openUlasanAdminImagePreview(this.dataset.previewSrc, this.dataset.previewTitle)" aria-label="Lihat Gambar {{ $num }}">
