                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="username" value="{{ old('username', $username ?? '') }}" placeholder="Masukkan username akun" required autofocus>
                            </div>

                            <div class="mb-3">
                                <label for="email" class="form-label fw-semibold">Email</label>
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $email ?? '') }}" placeholder="Masukkan email akun" required>
                            </div>
