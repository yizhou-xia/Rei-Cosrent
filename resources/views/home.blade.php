            ...
            <div class="card shadow-sm mb-4 search-card catalog-filter-card">
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="search" id="catalog-search" name="search" class="form-control" value="{{ $catalogSearch ?? '' }}" placeholder="Cari nama atau kategori katalog...">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="{{ (($catalogSearch ?? '') !== '' || ($catalogSort ?? 'name_asc') !== 'name_asc') ? 'col-md-2' : 'col-md-4' }} d-grid">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-search me-1" aria-hidden="true"></i> Cari
                        </button>
                    </div>
                    @if(($catalogSearch ?? '') !== '' || ($catalogSort ?? 'name_asc') !== 'name_asc')
                        <div class="col-md-2 d-grid">
                            <a href="{{ route('home') }}#kategori" class="btn btn-secondary">
